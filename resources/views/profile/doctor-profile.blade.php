    ...
    <div class="row ">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('profile1.store')}}" method="post">@csrf
        ...
        <div class="col-md-3">
            <div class="card">
             ...
             <form action="{{route('profile1.pic')}}" method="post" enctype="multipart/form-data">@csrf
                <div class="card-body">
                    @if(!auth()->user()->image)
                    <img src="/images/3Dz1og01c2vXjbjmfTskpLqdVGEB2Qmpg1DLROiR.png" width="120">
                    @else
                     <img src="/profile1/{{auth()->user()->image}}" width="120">
                    @endif
                    <br>
