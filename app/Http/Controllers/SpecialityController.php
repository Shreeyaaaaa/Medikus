...
class SpecialityController extends Controller
{
    ...
    {   //dd($request->all());
        ...
        $data = $request->all();
         $name = (new Speciality)->specAvatar($request);
        ...
        return redirect()->back()->with('message','Speciality created');
         }
    ...
    public function update(Request $request, $id)
    {
        ...
        $speciality->save();
        return redirect()->route('admin.speciality.index')->with('message','Speciality updated');
    }
    ...
    public function destroy($id)
    {
         $speciality = Speciality::find($id);
        $speciality->delete();
        return redirect()->route('speciality.index')->with('message','Speciality deleted');    }
